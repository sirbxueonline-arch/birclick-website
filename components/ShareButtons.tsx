...
export default function ShareButtons({
  prompt,
  copiedLabel,
  shareText = "BirClick — İşçiləri bir kliklə tap! birclick.az",
  shareUrl = "https://birclick.az",
}: Props) {
  ...
  return (
    <div className="flex flex-col items-center gap-3 mt-5">
      <p className="text-sm font-semibold opacity-70">{prompt}</p>
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          style={{
            borderColor: copied ? "#3B3BFF" : "rgba(255,255,255,0.2)",
            color: copied ? "#3B3BFF" : "inherit",
            backgroundColor: copied ? "rgba(59,59,255,0.08)" : "transparent",
          }}
        >
          {copied ? (
            <>
