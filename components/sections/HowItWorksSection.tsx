...
/* Icons stay in the component (can't put JSX in i18n.ts) */
const icons = [
...
export default function HowItWorksSection() {
  const { t } = useLanguage();
  const { eyebrow, title, sub, stepLabel, steps } = t.howItWorks;
    ...
    <section className="py-16 sm:py-28 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-10 sm:mb-16">
          ...
          <p className="text-gray-400 mt-4 text-base max-w-md mx-auto">{sub}</p>
        </div>
          ...
          {steps.map((step, idx) => (
            <div
              ...
              className="relative z-10 group bg-white border border-gray-100 rounded-3xl p-6 sm:p-8
                hover:border-transparent hover:shadow-2xl hover:-translate-y-2 transition-all duration-300"
            >
              <div
              ...
              <span className="text-xs font-black uppercase tracking-widest mb-3 block" style={{ color: "#3B3BFF" }}>
